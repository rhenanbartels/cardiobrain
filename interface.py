...
"")
        ...
        self.actionGet_original = QAction(MainWindow)
        self.actionGet_original.setObjectName(u"actionGet_original")
        self.menu_filters_hampel_light = QAction(MainWindow)
        self.menu_filters_hampel_light.setObjectName(u"menu_filters_hampel_light")
        self.menu_filters_hampel_medium = QAction(MainWindow)
        self.menu_filters_hampel_medium.setObjectName(u"menu_filters_hampel_medium")
        self.menu_filters_hampel_strong = QAction(MainWindow)
        self.menu_filters_hampel_strong.setObjectName(u"menu_filters_hampel_strong")
        self.menu_about_hampel = QAction(MainWindow)
        self.menu_about_hampel.setObjectName(u"menu_about_hampel")
        self.menu_filters_get_original = QAction(MainWindow)
        self.menu_filters_get_original.setObjectName(u"menu_filters_get_original")
        ...
        self.radioButtonSimulatedCoherence = ToggleButton(self.frame_10)
        self.radioButtonSimulatedCoherence.setObjectName(u"radioButtonSimulatedCoherence")
        self.radioButtonSimulatedCoherence.setMaximumSize(QSize(60, 30))
...
"")
        ...
        self.coherenceThreshold.setMaximumSize(QSize(60, 30))
...
"}")
        ...
        self.radioButtonApplyCoherence = ToggleButton(self.frame_10)
        self.radioButtonApplyCoherence.setObjectName(u"radioButtonApplyCoherence")
        self.radioButtonApplyCoherence.setMaximumSize(QSize(60, 30))
...
"}")
        ...
        self.topAxesComboBox.setMinimumSize(QSize(50, 30))
        self.topAxesComboBox.setMaximumSize(QSize(120, 16777215))
        ...
        self.bottomAxesComboBox.setMinimumSize(QSize(50, 30))
        self.bottomAxesComboBox.setMaximumSize(QSize(120, 16777215))

        self.gridLayout_4.addWidget(self.bottomAxesComboBox, 1, 2, 1, 3)

        self.radioButtonShowMarkers = ToggleButton(self.frame_11)
        self.radioButtonShowMarkers.setObjectName(u"radioButtonShowMarkers")
        self.radioButtonShowMarkers.setMinimumSize(QSize(0, 0))
        self.radioButtonShowMarkers.setMaximumSize(QSize(60, 30))

        self.gridLayout_4.addWidget(self.radioButtonShowMarkers, 2, 2, 1, 1)
...
"}")
        ...
        font2 = QFont()
        font2.setBold(False)
        self.lineEditPointEstimateFrequency.setFont(font2)
        ...
        self.frame_5.setMaximumSize(QSize(16777215, 230))
        ...
        self.menuHampel = QMenu(self.menuFilters)
        self.menuHampel.setObjectName(u"menuHampel")
        ...
        self.menuFilters.addAction(self.menuHampel.menuAction())
        self.menuFilters.addSeparator()
        self.menuFilters.addSeparator()
        self.menuFilters.addAction(self.menu_filters_get_original)
        self.menuHampel.addAction(self.menu_filters_hampel_light)
        self.menuHampel.addAction(self.menu_filters_hampel_medium)
        self.menuHampel.addAction(self.menu_filters_hampel_strong)
        self.menuHampel.addSeparator()
        self.menuHampel.addSeparator()
        self.menuHampel.addAction(self.menu_about_hampel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionGet_original.setText(QCoreApplication.translate("MainWindow", u"Get original", None))
        self.menu_filters_hampel_light.setText(QCoreApplication.translate("MainWindow", u"Light", None))
        self.menu_filters_hampel_medium.setText(QCoreApplication.translate("MainWindow", u"Medium", None))
        self.menu_filters_hampel_strong.setText(QCoreApplication.translate("MainWindow", u"Strong", None))
        self.menu_about_hampel.setText(QCoreApplication.translate("MainWindow", u"About", None))
        self.menu_filters_get_original.setText(QCoreApplication.translate("MainWindow", u"Original signals", None))
        ...
        self.overlapSize.setText(QCoreApplication.translate("MainWindow", u"250", None))
        self.resamplingFrequency.setInputMask(QCoreApplication.translate("MainWindow", u"00", None))
        self.resamplingFrequency.setText(QCoreApplication.translate("MainWindow", u"5", None))
        self.segmentSize.setInputMask("")
        self.segmentSize.setText(QCoreApplication.translate("MainWindow", u"500", None))
        ...
        self.topAxesComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Filt. Coherence", None))
        self.topAxesComboBox.setItemText(5, QCoreApplication.translate("MainWindow", u"Phase", None))
        self.topAxesComboBox.setItemText(6, QCoreApplication.translate("MainWindow", u"ABP x CBFV", None))
        ...
        self.bottomAxesComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Filt. Coherence", None))
        self.bottomAxesComboBox.setItemText(5, QCoreApplication.translate("MainWindow", u"Phase", None))
        self.bottomAxesComboBox.setItemText(6, QCoreApplication.translate("MainWindow", u"ABP x CBFV", None))
        ...
        self.menuHampel.setTitle(QCoreApplication.translate("MainWindow", u"Hampel", None))
    # retranslateUi
